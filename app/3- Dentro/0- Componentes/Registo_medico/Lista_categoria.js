    ...
    return (
      <Card noShadow={true} style={{flex:1,width:'45%', height: 50 , borderRadius:5, borderColor:'white'}} >
        ...
        <View style={{flexDirection:'row'}}>
          ...
          <Image source={require('../../../../assets/icon/doenca1.png')} style={{width: 40, height:40, borderRadius:8, marginRight:'7%'}}/>
          
         
          <View style={{flexDirection:'row'}}>
            
              <View style={{width:'53%', marginTop:'0%',marginRight:'3%'}}>
                
                <Text style={[styles.titulo2]}>{this.props.nome}</Text>
                <View style={{marginTop:'4%', flexDirection:'row'}}>
                  <Image 
                  style={{width:15, height:15.5}}
                  source={require('../../../../assets/icon/calendario1.png')}/>
