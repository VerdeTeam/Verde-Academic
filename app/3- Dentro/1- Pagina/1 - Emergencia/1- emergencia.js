...
const acoes =[
  ...
  //{id: 7, cor:'white'},
  //{id: 7, capa: require('../../../../assets/Imagens/prontosocorro/outro3.png'), titulo:'Dia a Dia'},
]
  ...
  const headerY = Animated.interpolate(diffClampScrollY,{
    ...
    return (
      ...
      <View style={{position:'absolute',shadowColor:'white',elevation:1.5, zIndex:110,backgroundColor:'white', width:220, height:49.5, borderBottomRightRadius:23, borderbottomrightColor:'transparent', borderColor:'transparent'}}>{/* MANIPULAÇÃO DO SCROLL DO MENU */}
        <Right style={{left:85,flexDirection:'row',top:-2}}>
 ...
 <View style={{position:'absolute',elevation:1, zIndex:110,backgroundColor:'white', width:115, height:49.5, borderBottomRightRadius:10}}/>{/* MANIPULAÇÃO DO SCROLL DO MENU */}
    ...
    >
          ...
          <View  style={{paddingTop:65}}>   
            ...
            source = {require('../../../../assets/icon/coracao_circulo.png')}/>
            ...
            >
              <View style={{flex:1, marginLeft:5, marginRight:20, padding:15}}>
                <Text style={styles.descricao}>
                  O melhor kit de sobrevivencia, é o conhecimento de sobreviver. Entenda como
                  lidar e gerir situações de risco e estejá sempre um passo afrente
                </Text>
              </View>
            </Card>
          </View>
