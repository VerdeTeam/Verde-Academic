...
const acoes =[
  {id: 1, capa: require('../../../../assets/Imagens/consultas/doencas2.png'), titulo:'Comuns em Angola'},
  {id: 2, capa: require('../../../../assets/Imagens/consultas/doencas3.png'), titulo:'Comuns em Africa'},
  {id: 3, capa: require('../../../../assets/Imagens/consultas/doencas4.png'), titulo:'Doenças Sem Cura'},
  {id: 4, capa: require('../../../../assets/Imagens/consultas/doencas5.png'), titulo:'Todas Doenças'},
]

//vARIAVEL GLOBAL PARA MANIPULAÇÃO DO MENU SCROLL
const HEADER_HEIGHT = 70

class Doesin_doen extends Component {
...
//SCROLL MENU FUNCTIOM
  ...
  const headerY = Animated.interpolate(diffClampScrollY,{
    ...
    return (
      ...
      <View style={{position:'absolute',shadowColor:'white',elevation:1.5, zIndex:110,backgroundColor:'white', width:170, height:49.5, borderBottomRightRadius:23, borderbottomrightColor:'transparent', borderColor:'transparent'}}>{/* MANIPULAÇÃO DO SCROLL DO MENU */}
        <Right style={{left:65,flexDirection:'row',top:-5}}>
    ...
    >
          ...
          <View>
            ...
            <View  style={{paddingTop:115}}>   
              ...
              >
                <View style={{flex:1, marginLeft:5, marginRight:20, padding:20}}>
                 <Text style={styles.descricao}>
                    Listamos quatro opções que acreditamos que poderão o ajudar… 
                    Vê as doenças e as suas dicas para prevenção e combate de forma organizada e categorica!
                  </Text>
                </View>
              </Card>
            </View>
