...
class Gravidez extends Component {
...
//SCROLL MENU FUNCTIOM
  ...
  const headerY = Animated.interpolate(diffClampScrollY,{
    ...
    return (
      ...
      <View style={{position:'absolute',shadowColor:'white',elevation:1.5, zIndex:110,backgroundColor:'white', width:255, height:49.5, borderBottomRightRadius:23, borderbottomrightColor:'transparent', borderColor:'transparent'}}>{/* MANIPULAÇÃO DO SCROLL DO MENU */}
    ...
    >
          ...
          <View>
            ...
            <View  style={{paddingTop:65}}>   
              ...
              source = {require('../../../../assets/icon/gravida/estrela_circulo.png')}/>
              ...
              >
                <View style={{flex:1, marginLeft:5, marginRight:20, marginTop:20}}>
                 <Text style={styles.descricao}>Á area de dicas para gravidas foi criada para dar suporte e levar o conceito a todas as mulheres de Angola… <Text style={{fontFamily:'Roboto-Bold'}}>Desfrute!</Text></Text>
                </View>
              </Card>
            </View>
          ...
          <View style={{paddingTop:20, paddingBottom:10}}>
            <TouchableOpacity onPress={()=> Actions.emergencia_pr()}>
              <Card style={{elevation:0,backgroundColor:'#DE9E30', borderRadius:24, width:null, height:83, borderColor:'transparent'}}>
                <Image source={require('../../../../assets/Imagens/gravida/dicas1.jpg')} style={{width:'100%',height:'100%', borderRadius:23}}/>
                <View style={{width:'100%',flexDirection:'row', position:'absolute', top:23}}>
                  <Text style={[styles.titulo,{backgroundColor:'#DE9E30'}]}>DICAS SOBRE GRAVIDEZ</Text>
                  <Button style={{elevation:0 ,right:12,backgroundColor:'#DE9E30', borderRadius:23,
          ...
          <View style={{paddingTop:20, paddingBottom:10}}>
            <TouchableOpacity onPress={()=> Actions.emergencia_pr()}>
              <Card style={{elevation:0,backgroundColor:'#DE9E30', borderRadius:24, width:null, height:83, borderColor:'transparent'}}>
                <Image source={require('../../../../assets/Imagens/gravida/encontre1.jpg')} style={{width:'100%',height:'100%', borderRadius:23}}/>
                <View style={{width:'100%',flexDirection:'row', position:'absolute', top:23}}>
                  <Text style={[styles.titulo,{backgroundColor:'#DE9E30'}]}>ENCONTRAR MATERNIDADE</Text>
                  <Button style={{elevation:0 ,right:12,backgroundColor:'#DE9E30', borderRadius:23,
                  alignItems:'center', justifyContent:'center',
                  width:29, height:29, position:'absolute'}}>
                  <Image style={{ width:24, height:24}}
          ...
          <View style={{paddingTop:20, paddingBottom:15}}>
            ...
            source = {require('../../../../assets/icon/gravida/gravida_circulo.png')}/>
            <Card style={{elevation:0,marginTop:'3%',             
            borderRadius:23, 
            borderColor:'transparent',
            backgroundColor:'white',
            ...
            >
              <View style={{flexDirection:'row'}}>
                <View style={{flex:1, marginLeft:30, marginRight:20, marginTop:7, paddingRight:30}}>
                  <Form>
                    <Picker
                      note
                      mode="dropdown"
                    ...
                    >
                      <Picker.Item label="Trimestre Como Gestante" value="key0" />
                      <Picker.Item label="I - De 1 a 3 Mêses" value="key1" />
                      <Picker.Item label="II - De 3 a 6 Mêses" value="key2" />
                      <Picker.Item label="III - De 6 a 9 Mêses" value="key3" />
                    </Picker>
                  </Form>
                </View>
                <Button style={{marginTop:15, position:'absolute',elevation:0 ,right:12,backgroundColor:'black', borderRadius:23,
                  alignItems:'center', justifyContent:'center',
                  width:29, height:29}}>
                  <Image style={{ width:24, height:24}}
                    source = {require('../../../../assets/icon/menu/avancar2.png')}/>
